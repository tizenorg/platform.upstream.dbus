                             ...
                             dbus_bool_t      getLabel)
{
  ...
  if ((ret = kdbus_connection_info_by_name (transport, name, getLabel, info)) < 0)
    {
                                                       ...
                                                       unsigned long              *val)
{
  ...
  ret = kdbus_connection_info_by_id (transport,
                                     ((DBusTransportKdbus *)transport)->my_kdbus_id,
                                     FALSE,
                                     &conn_info);
  if (ret < 0)
    return FALSE;
                     ...
                     const char       *activator)
{
  ...
  kdbus_transport->base.is_kdbus = TRUE;
